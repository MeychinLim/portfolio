            ...
            <ul className='timeline timeline-snap-icon max-md:timeline-compact timeline-vertical'>
                {experiences.map((experience, index) => (
                    <li key={index}>
                        ...
                        <time className='font-mono italic text-lg md:text-xl mt-7 px-2 text-end w-full hidden md:block'>
                            {experience?.duration}
                        </time>
                        <div className='timeline-end mb-10'>
                            <time className='font-mono italic text-lg md:text-xl block md:hidden'>
                                {experience?.duration}
                            </time>
